...
const DynamicCard = ({ title, color = "pink", image, textPrincipiant }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`${!open ? "opacity-0 z-0" : "opacity-100 z-20 -top-50"}
          transition-opacity duration-200
          relative
      ...
      >
        ...
        <h3
          className="
            mt-2 mb-3 text-center uppercase text-xl
        ...
        <div className="flex flex-row items-center m-3">
          {/* Image */}
          <div className="w-[95%] h-full ml-3 mr-3 mb-3 rounded-md overflow-hidden">
            <img src={image} alt={title} className="w-auto h-full" />
          </div>

          {/* Text */}
          {textPrincipiant && (
            <div className="ml-3 mr-3 text-xl mb-3 md:w-full">
              {textPrincipiant}
            </div>
          )}
        </div>
